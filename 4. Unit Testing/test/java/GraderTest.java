...
public class GraderTest {
    ...
    public void creditThreeBoundaryCheckForB(){
        var grader = new Grader();
        assertEquals("B", grader.calculateGrade("209.5", "3"));
    }
    ...
    public void creditThreeBoundaryCheckForC(){
        var grader = new Grader();
        assertEquals("C", grader.calculateGrade("179.5", "3"));
    }
    ...
    public void creditThreeBoundaryCheckForF(){
        var grader = new Grader();
        assertEquals("F", grader.calculateGrade("178.5", "3"));
    }
    ...
    public void creditFourBoundaryCheckForB(){
        var grader = new Grader();
        assertEquals("B", grader.calculateGrade("279.5", "4"));
    }
    ...
    public void creditFourBoundaryCheckForC(){
        var grader = new Grader();
        assertEquals("C", grader.calculateGrade("239.5", "4"));
    }
    ...
    public void creditFourBoundaryCheckForF(){
        var grader = new Grader();
        assertEquals("F", grader.calculateGrade("238.5", "4"));
    }

    @Test
    public void checkForNonIntegerScoreInput(){
        var grader = new Grader();
        assertThrows(NumberFormatException.class, () -> {
            grader.calculateGrade("abc", "3");
        });
    }

    @Test
    public void checkForNonIntegerCreditInput(){
        var grader = new Grader();
        assertThrows(NumberFormatException.class, () -> {
            grader.calculateGrade("240", "2");
        });
    }
}
